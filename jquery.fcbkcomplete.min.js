...
{cache.push({caption:val.caption,value:val.value,paginate:val.paginate});if(val.caption!=''){search_string+=""+(cache.length-1)+":"+val.caption+";";}
