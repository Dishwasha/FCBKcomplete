...
{content+='<li rel="'+object.value+'">'+itemIllumination(object.caption,etext);content+=object.extra.content+'</li>';counter++;maximum--;}
...
{var option=$(this);addItem(option.text(),option.attr("rel"));feed.hide();browser_msie?browser_msie_frame.hide():'';complete.hide();});feed.children("li.noclick").unbind("mousedown");bindPaginateEvents();maininput.unbind("keydown");maininput.keydown(function(event)
{if(event.keyCode==191)
